...
t0=$(awk "{print \$1}" /proc/uptime); /work/out/kura-native -Xmx512m -Datomos.lib.dir=/work $KURA_PROPS ${NATIVE_LIBS_OPT:-} -Dkura.atomos.dump=true -Dkura.atomos.dumpAfter=40 > /work/native-run.out 2>&1 & P=$!
